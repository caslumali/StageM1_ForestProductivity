...
## 1.2 ROI ----
# ---------------------------------------------------------------- - - -
SITES = c("Cotriguacu", "Guaviare", "MDD") # If you want to loop through multiple sites, add them to this vector
...
for (i in 1:length(SITES)) {
  ...
  combined_line_plot(line_plot_data_evi, line_plot_data_degradation, file.path(OUT_FOLDER, str_glue("{Site}_01_EVI_Degradation_Area.png")))
  ...
  #                                                          #
  ##%######################################################%##
  write.csv(line_plot_data_evi, file.path(OUT_FOLDER, str_glue("{Site}_01_EVI_area_km2_data.csv")), row.names = FALSE)
  write.csv(line_plot_data_degradation, file.path(OUT_FOLDER, str_glue("{Site}_01_Degradation_area_km2_data.csv")), row.names = FALSE)
