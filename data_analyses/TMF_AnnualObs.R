...
# ---------------------------------------------------------------- - - -
SITES = c("MDD") # If you want to loop # 'Cotriguacu', 'Guaviare', 'MDD', 'Paragominas'
# Site <- "Paragominas"
...
SAVE_CLASSIFIED <- FALSE # If TRUE, save the classified raster (0, 25%, 50%, 75%, 100%);
...
for (i in 1:length(SITES)) {
  ...
  OUT_FOLDER <- stringr::str_glue("results/{Site}/Productivity/TMF_AObs_deg")
