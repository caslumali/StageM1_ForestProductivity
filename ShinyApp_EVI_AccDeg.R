...
server <- function(input, output, session) {
  ...
  output$map <- renderLeaflet({
    leaflet() %>%
      addProviderTiles(providers$Esri.WorldImagery, group = "Esri World Imagery", options = providerTileOptions(opacity = 0.4)) %>%  # Ajustar a opacidade do mapa base
      addProviderTiles("OpenStreetMap.Mapnik", group = "OSM", options = providerTileOptions(opacity = 0.4)) %>%  # Ajustar a opacidade do mapa base
      ...
      addRasterImage(deg_1990_2005, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2005") %>%
      addRasterImage(deg_1990_2008, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2008") %>%
      addRasterImage(deg_1990_2011, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2011") %>%
      addRasterImage(deg_1990_2014, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2014") %>%
      addRasterImage(deg_1990_2017, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2017") %>%
      addRasterImage(deg_1990_2020, colors = color_pal_deg, opacity = 0.7, project = FALSE, group = "Degradation 1990-2020") %>%
      addLayersControl(
        overlayGroups = c("EVI",
                          "EVI Class 2000-2005",
                          "EVI Class 2003-2008",
